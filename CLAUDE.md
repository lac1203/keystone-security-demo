...
> **Data Scope:** 24 months of transactional data for a Mid-Atlantic security hardware distributor
...
annual_revenue: "$18.5M (Year 1) → $19.98M (Year 2, +8% YoY)"
employees: 42
warehouse_locations:
...
| Dataset | Year 1 | Year 2 | Total |
|---------|--------|--------|-------|
| Products | 200+ SKUs | - | 200+ |
| Customers | 150 accounts | - | 150 |
| Orders | 3,800 | 4,104 | 7,904 |
| Order Lines | ~17,100 | ~18,468 | ~35,568 |
